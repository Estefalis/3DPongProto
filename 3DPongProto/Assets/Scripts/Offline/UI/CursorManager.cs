...
namespace ThreeDeePongProto.Shared.UI
{
    public class CursorManager : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            //m_menuPlayerInput.onControlsChanged += OnInputDeviceChanged;
        ...
        //{
        //    if (m_menuPlayerInput.m_lastActiveControlScheme == m_keyboardMouseScheme && m_lastControlSchemeChange != m_keyboardMouseScheme)
        //    {
        ...
        //    }
        //    else if (m_menuPlayerInput.m_lastActiveControlScheme == m_gamePadScheme && m_lastControlSchemeChange != m_gamePadScheme)
        //    {
        ...
        //May Update() 'if(m_lastControlSchemeChange != m_menuPlayerInput.m_lastActiveControlScheme) with an own 'OnControlsChanged()' method. And update 'm_lastControlSchemeChange = m_menuPlayerInput.m_lastActiveControlScheme;' to it.
        #endregion
