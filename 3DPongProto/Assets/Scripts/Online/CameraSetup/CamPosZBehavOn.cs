...
using ThreeDeePongProto.Online.Player.Inputs;
using UnityEngine;
using UnityEngine.InputSystem;

namespace ThreeDeePongProto.Online.CameraSetup
{
    public class CamPosZBehavOn : MonoBehaviour
    {
        // Start is called before the first frame update
        private PlayerInputActions m_cameraInputActions;
        [SerializeField] private PlayerControlPosZOn m_playerControlPosZOn;
        ...
        private void Awake()
        {
            ...
            m_playerId = m_playerControlPosZOn.PlayerId;
