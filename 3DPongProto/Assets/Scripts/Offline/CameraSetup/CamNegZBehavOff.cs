...
namespace ThreeDeePongProto.Offline.CameraSetup
{
    public class CamNegZBehavOff : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            m_playerId = m_playerControlSubNegZ.PlayerId;
        ...
        private void Start()
        {
            ...
            m_cameraInputActions.PlayerActionsNeg.Zoom.performed += Zooming;
        ...
        private void GetMousePosition()
        {
            ...
            m_mousePosition = m_cameraInputActions.PlayerActionsNeg.MousePosition.ReadValue<Vector2>();
#else
        ...
        private void UpdateZoomPosition()
        {
            ...
            if (m_cameraInputActions.PlayerActionsNeg.enabled)
            {
